                    ...
                    @if(Cart::count() > 0)
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <label for="street-first">Street Address<span>*</span></label>
                                    <input type="text" id="street-first" name="street_address" value="{{Auth::user()->stress_address ?? ''}}">
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <label for="town">Towm / City <span>*</span></label>
